...
import com.example.oxygenmeter.Math.Fft;
...
public class OxygenProcess extends Activity {
    ...
    private final PreviewCallback previewCallback = new PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            RedAvg = ImageProcessing.colordecoderRGB(data.clone(), height, width, 1); //1 stands for red intensity, 2 for blue, 3 for green
            sumred = sumred + RedAvg;
            BlueAvg = ImageProcessing.colordecoderRGB(data.clone(), height, width, 2); //1 stands for red intensity, 2 for blue, 3 for green
